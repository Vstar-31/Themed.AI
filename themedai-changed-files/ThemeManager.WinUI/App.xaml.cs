...
public partial class App : Application
{
    ...
    protected override async void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        // own remarks) and previously had no logger wired up at all, so failures inside them
        // (a stuck preview player, a malformed WebView2 message) were completely invisible.
        // Must happen before any widget can open — SkinManager below is what opens them.
        ThemeManager.Integration.Skins.VibeFinderPreviewPlayer.Initialize(LoggerFactory.CreateLogger("ThemeManager.Integration.Skins.VibeFinderPreviewPlayer"));
        ThemeManager.Integration.Skins.VibeFinderWebState.Initialize(LoggerFactory.CreateLogger("ThemeManager.Integration.Skins.VibeFinderWebState"));
