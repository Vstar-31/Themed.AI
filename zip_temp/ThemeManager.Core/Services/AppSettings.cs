...
public sealed class AppSettings
{
    ...
    /// <summary>Phase 7: time-of-day / light-dark / battery-saver theme automation rules.
    /// Disabled by default — see <see cref="ThemeSchedule.Enabled"/> and the Settings page's
    /// "Theme Automation" section.</summary>
    public ThemeSchedule Schedule { get; set; } = new();
