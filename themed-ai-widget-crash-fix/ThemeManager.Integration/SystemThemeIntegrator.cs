...
public sealed class SystemThemeIntegrator : ISystemThemeIntegrator
{
    ...
    public Task<bool> IsBatterySaverActiveAsync()
    {
        return Task.Run(() =>
        {
            try
            ...
            {
                // No battery (most desktops), or the WinRT power APIs aren't available on this
                // build — either way "never active" is the safe, honest default.
                return false;
            }
        });
    }
