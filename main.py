...
async def analyze_vibe(request: VibeRequest, token: str = Depends(oauth2_scheme)):
    ...
    # clients get a concrete, playable video_id instead of having to run their
    # own YouTube search, which is what Themed.AI's WebView2 player was doing
    # via the IFrame API's listType='search' before that was deprecated.
    ...
    for i, t in enumerate(best_tracks):
        ...
        final_tracks.append({
            ...
            "youtube_video_id": _youtube_ids[i],
        })
