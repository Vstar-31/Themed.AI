...
public static class DefaultWidgetCatalog
{
    ...
    private static void BuildPrimary(SkinDefinition skin, string target)
    {
        ...
        {
            Text("VF", 18, 14, 34, 22, 11, true), Text("VibeTitle", 18, 42, 315, 30, 21, true),
            Text("VibeArtist", 18, 72, 315, 24, 13, false), Text("VibeMood", 18, 98, 315, 22, 12, false),
            new() { Kind = MeterKind.Bar, MeasureName = "VibeProgress", X = 18, Y = 128, Width = 270, Height = 6, BarMax = 100 },
            Icon("Prev", "\uE100", 292, 116, 24, 30, "themed://media/prev"),
            Icon("VibeState", "\uE768", 320, 114, 30, 32, "themed://media/playpause"),
            Icon("Next", "\uE101", 354, 116, 24, 30, "themed://media/next"),
        };
    ...
    private static void BuildMinimal(SkinDefinition skin, string target)
    {
        ...
        skin.Meters = new List<MeterDefinition>
        {
            Text("VibeTitle", 14, 8, 214, 27, 16, true), Text("VibeArtist", 14, 35, 214, 21, 12, false),
            Icon("VibeState", "\uE768", 244, 10, 30, 30, "themed://media/playpause"),
    ...
    private static void BuildPlaylist(SkinDefinition skin, string target)
    {
        ...
        skin.Meters = new List<MeterDefinition>
        {
            Text("VIBE FINDER", 18, 14, 200, 22, 11, true), Text("VibeMood", 18, 40, 365, 22, 12, false),
            Text("VibeTitle", 18, 70, 360, 32, 22, true), Text("VibeArtist", 18, 104, 360, 24, 13, false),
            new() { Kind = MeterKind.Ring, MeasureName = "VibeProgress", X = 18, Y = 140, Width = 48, Height = 48, BarMax = 100 },
            Text("VibeProgress", 78, 152, 210, 24, 12, false),
            Icon("Prev", "\uE100", 304, 148, 28, 32, "themed://media/prev"),
            Icon("VibeState", "\uE768", 338, 144, 36, 38, "themed://media/playpause"),
            Icon("Next", "\uE101", 380, 148, 28, 32, "themed://media/next"),
